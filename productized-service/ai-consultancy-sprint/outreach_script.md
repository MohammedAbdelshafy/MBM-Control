# AI Consultancy Sprint — Outreach Script (Cold + Warm)
...
## 1. Cold call opener (15s)
"Hey [Name], it's [You] with AI Enhancement. Quick one — are you still spending on [Google/FB/Thumbtack/Yelp] leads that don't convert?"
[If yes] "We install an AI system that calls, qualifies, and follows up with your best-fit customers — so you book more jobs without hiring a sales team. Takes 14 days. Can I send you a free AI plan for your business?"

## 2. Pain hook (if they ask "what do you mean")
...
## Objection handling
- "Too expensive" → "It's less than one dead lead month. And the Managed $497/mo pays for itself the first booked job."
- "We have someone" → "Great — point our AI at the leads they don't get to. It qualifies and follows up, your team closes."
- "Send info" → send Audit link + free-plan offer, never just a PDF.

## Proof points (honest)
- Same AI cold-calling assistant + verified lead engine we run in production.
- 30-day money-back on Audit.
- Turnaround: Audit 72h, Build 14 days.
