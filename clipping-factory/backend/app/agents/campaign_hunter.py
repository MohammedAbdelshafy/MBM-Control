...
class CampaignHunterAgent(BaseAgent):
    ...
    def _demo_campaigns(self) -> list[dict]:
        ...
        return [
            ...
            {
                "id": f"contentrewards-ugc-{ts}",
                "title": "ContentRewards.com Creator Bounties & UGC Clips",
                "brand": "ContentRewards",
                "platform_name": "ContentRewards.com",
                "url": "https://contentrewards.com/campaigns/ugc-bounties",
                "pay": "$7.50 per 1k views",
                "payout_per_1k_views": 7.50,
                "max_payout_cap": 5000.00,
                "due_date": "2026-08-30",
                "source_url": "https://cdn.pixabay.com/video/2020/02/17/32511-392669641_large.mp4",
                "requirements": {
            ...
            {
                "id": f"painpoint-agency-piphouse-{ts}",
                "title": "PainPoint AI Agency Pitch: PipHouse LLC Automation",
                "brand": "PipHouse LLC (Pain Point Target)",
                "platform_name": "PainPointApp",
                "url": "https://mbm-agency.com/painpoints/piphouse",
                "pay": "$35.00 per 1k views",
                "payout_per_1k_views": 35.00,
                "max_payout_cap": 5000.00,
                "due_date": "2026-08-28",
                "source_url": "https://cdn.pixabay.com/video/2020/02/17/32511-392669641_large.mp4",
                "requirements": {
