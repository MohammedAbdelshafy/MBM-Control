...
Event Types:
  ...
  EMAIL_SENT, EMAIL_FAILED, EMAIL_REPLY_DETECTED,
  FACEBOOK_SIGNAL, NEWS_SIGNAL
=================================================================================================================
"""
...
class GtmEventType(str, Enum):
    ...
    EMAIL_REPLY_DETECTED = "EMAIL_REPLY_DETECTED"
    # Intelligence source events
    FACEBOOK_SIGNAL = "FACEBOOK_SIGNAL"
