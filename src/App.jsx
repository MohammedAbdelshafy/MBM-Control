...
const AuthenticatedApp = () => {
  ...
  return <Suspense fallback={<PageLoader />}><Routes>
    ...
    <Route path="/dialer" element={<ResponsiveDialerHome />} /><Route path="/auto-dialer" element={<ResponsiveDialerHome />} /><Route path="/dialer/mobile" element={<MobileDialer />} /><Route path="/mobile-dialer" element={<MobileDialer />} />
    <Route path="/affiliates" element={<AffiliateAnalytics />} /><Route path="/mbm" element={<ResponsiveDialerHome />} /><Route path="/mbm-dashboard" element={<ResponsiveDialerHome />} />
